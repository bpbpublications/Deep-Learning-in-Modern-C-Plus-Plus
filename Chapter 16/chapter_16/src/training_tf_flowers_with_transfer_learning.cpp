...
public:
    ...
    Model(DEVICE &device, GEN &rng, int img_size, int number_of_classes): IMG_SIZE(img_size), number_of_classes(number_of_classes) {
        ...
        load_tensor_from_file(kernels_0, "../../models/dogs_cats_augmentation/runs/88.09/38/conv2d_0_kernels.txt");
        Tensor_1D bias_0(kernels_0.dimension(3));
        load_tensor_from_file(bias_0, "../../models/dogs_cats_augmentation/runs/88.09/38/conv2d_0_bias.txt");
        this->conv2d_0 = new Conv2DLayer(device, kernels_0, bias_0, new ReLU<DEVICE, 4>(device), std::vector<int>{1, 1, 1, 1});
        ...
        load_tensor_from_file(kernels_1, "../../models/dogs_cats_augmentation/runs/88.09/38/conv2d_1_kernels.txt");
        Tensor_1D bias_1(kernels_1.dimension(3));
        load_tensor_from_file(bias_1, "../../models/dogs_cats_augmentation/runs/88.09/38/conv2d_1_bias.txt");
        this->conv2d_1 = new Conv2DLayer(device, kernels_1, bias_1, new ReLU<DEVICE, 4>(device), std::vector<int>{1, 1, 1, 1});
        ...
        load_tensor_from_file(kernels_2, "../../models/dogs_cats_augmentation/runs/88.09/38/conv2d_2_kernels.txt");
        Tensor_1D bias_2(kernels_2.dimension(3));
        load_tensor_from_file(bias_2, "../../models/dogs_cats_augmentation/runs/88.09/38/conv2d_2_bias.txt");
        this->conv2d_2 = new Conv2DLayer(device, kernels_2, bias_2, new ReLU<DEVICE, 4>(device), std::vector<int>{1, 1, 1, 1});
